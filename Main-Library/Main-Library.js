...
//this code saves a page to the history data file each time a page is pressed
...
topicsBtn.onclick=e=>{
  sessionStorage.setItem('savedSearch2', '');
  window.location.href = '../Topics-Library-page/Topics-Library.html';
};
